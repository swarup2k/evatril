...
<!-- color theme -->
<link href="{{ asset('frontend/css/colors/4.css')}}" rel="stylesheet">
...
<script>
        ...
        if ($('#currency-change').length > 0) {
            $('#currency-change .dropdown-item a').each(function() {
                $(this).on('click', function(e){
                    ...
                    $.post('#',{_token:'{{ csrf_token() }}', currency_code:currency_code}, function(data){
                        location.reload();
                    });
    ...
    function search(){
        ...
        if(search.length > 0){
            ...
            $.post('#', { _token: '{{ @csrf_token() }}', search:search}, function(data){
                if(data == '0'){
    ...
    function removeFromCart(key){
        $.post('#', {_token:'{{ csrf_token() }}', key:key}, function(data){
            updateNavCart();
